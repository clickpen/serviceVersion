	...
	<div class="system-manage-wrapper" id="systemModel" v-cloak>
			...
			<el-tab-pane label="用户管理" name="userManage">
				<div class="child-wrapper child-map">
					<el-table :data="usermanageTableData">
						...
						<el-table-column label="生效时间" prop="effectiveTime" width="180" show-overflow-tooltip></el-table-column>
		...
		<el-dialog :visible="usermanageDialogShow" width="650px;height:700px;" :title="addUserDialogTitle"
			...
			<div class="usermanage-dialog-wrapper">
				<el-upload class="usermanage-hd" action="/jetk/identityConfig/uploadImage"
					:show-file-list="false" 
					:before-upload="beforeAvatarUpload"
					:on-success="handleUploadFile">
					<img v-if="usermanageDialogForm.picturePath" style="width:50px;height:50px;" :src="'/jetk/picture/'+usermanageDialogForm.picturePath">
